...
class RolesCrud extends CrudService
{
    ...
    public function setActions( CrudEntry $entry ): CrudEntry
    {
        ...
        $entry->action(
            ...
            label: __( 'Edit' ),
            type: 'GOTO',
            url: nsUrl( '/dashboard/' . 'users/roles' . '/edit/' . $entry->id )
        );
        ...
        $entry->action(
            ...
            url: nsUrl( '/api/' . 'users/roles/' . $entry->id . '/clone' )
        );
        ...
        $entry->action(
            ...
            label: __( 'Delete' ),
            type: 'DELETE',
            url: nsUrl( '/api/crud/ns.roles/' . $entry->id ),
            confirm: [
    ...
    {
        return [
            'list' => nsUrl( 'dashboard/' . 'users/roles' ),
            'create' => nsUrl( 'dashboard/' . 'users/roles/create' ),
            'edit' => nsUrl( 'dashboard/' . 'users/roles/edit/{id}' ),
            'post' => nsUrl( 'api/crud/' . 'ns.roles' ),
            'put' => nsUrl( 'api/crud/' . 'ns.roles/{id}' . '' ),
        ];
    }
