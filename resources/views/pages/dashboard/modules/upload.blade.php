    ...
    <div class="px-4 flex flex-col" id="dashboard-content">
        ...
        <div>
            <div class="flex justify-between items-center">
                <div class="ns-button">
                    <a href="{{ nsRoute( 'ns.dashboard.modules-list' ) }}" class="rounded-lg text-fontcolor shadow px-3 py-1"><i class="las la-angle-left"></i> {{ __( 'Go Back' ) }}</a>
                </div>
            </div>
            <form action="{{ nsRoute( 'ns.dashboard.modules-upload-post' ) }}" method="post" enctype="multipart/form-data">
                @csrf
